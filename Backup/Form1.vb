...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.TextBox1.Size = New System.Drawing.Size(344, 208)
...
#End Region
    ...
    Private Sub Form1_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        wsClient.Connect("irc.flamed.net", 6667)
    End Sub
    ...
    Private Sub wsClient_onConnect() Handles wsClient.onConnect
        ...
        wsClient.SendData(wsClient.StringToBytes("NICK Trivex_" & vbCrLf))
        wsClient.SendData(wsClient.StringToBytes("USER MyTester localhost 0.0.0.0 :I am coded in VB.NET" & vbCrLf))
    End Sub
